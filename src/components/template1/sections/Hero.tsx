...
export const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex flex-col justify-center px-6 md:px-20 pt-10 md:pt-20 overflow-hidden">
      <div className="z-10 max-w-6xl mx-auto">
        ...
        <motion.h1
          ...
          className="font-display text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] font-bold leading-[0.9] tracking-tighter text-white mix-blend-difference mb-8"
        >
          BACKEND <br />
        ...
        <motion.p
          ...
          className="font-mono text-slate-200 max-w-2xl text-base md:text-lg leading-relaxed mb-12"
        >
