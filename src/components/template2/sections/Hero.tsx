      ...
      <div className="max-w-4xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <span className="hero-line-2 block mb-1">
            ...
            <span className="hero-word inline-block mr-[0.3em]">systems,</span>
          </span>
          <span className="hero-line-3 block">
            ...
            <span className="hero-word hero-emphasis inline-block">weekends.</span>
          </span>
        </h1>
